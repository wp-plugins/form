...
<div class="cc-support-us"><script type="text/javascript"
	src="http://connect.facebook.net/en_US/all.js#xfbml=1"
></script>
<p>If you like this plugin, please share it with your friends</p>
<div style="align: center; margin-bottom: 15px; text-align: center"><a style="margin-bottom: 15px"
	href="http://www.twitter.com/zingiri"
><img align="middle" src="http://twitter-badges.s3.amazonaws.com/follow_us-a.png"
	alt="Follow Zingiri on Twitter"
/></a></div>
<div style="margin-bottom: 15px; text-align: center"><fb:share-button
	href="http://www.zingiri.net/plugins-and-addons/<?php echo $shareName;?>/" type="button"
></div>
<p>Rate our plugin on Wordpress</p>
<a href="http://wordpress.org/extend/plugins/<?php echo $wpPluginName;?>" alt="Rate our plugin"> <?php for ($i=0;$i<5;$i++) {?>
<img height="35px" src="http://www.zingiri.net/wordpress/wp-content/uploads/stars.png" /> <?php }?>
</a> <?php 
...
<h3><?php echo $rec->title;?></h3>
	<?php echo $rec->content;?></div>
	<?php
	}
}?>

<div style="text-align: center; margin-top: 40px"><a href="http://www.zingiri.net" target="_blank"><img
	src="http://www.zingiri.net/logo.png"
/></a></div>
</div>
<?php
	}
